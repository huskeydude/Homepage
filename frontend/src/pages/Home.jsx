      ...
      <div className="max-w-4xl w-full relative z-10">
        ...
        <div className="text-center mb-12 animate-fade-in">
          <div className="relative inline-block mb-6">
            ...
            {/* Slow Rotating Galaxy Centerpiece - Orbiting Particles */}
            <div className="absolute inset-0 w-48 h-48" style={{ animation: 'galaxy-orbit 90s linear infinite' }}>
              {/* Particle 1 - Cyan */}
              <div className="absolute top-0 left-1/2 w-2 h-2 -ml-1 bg-cyan-400 rounded-full shadow-lg shadow-cyan-400/50" style={{ 
                boxShadow: '0 0 10px 2px rgba(34, 211, 238, 0.6)' 
              }}></div>
              {/* Particle 2 - Pink */}
              <div className="absolute top-1/2 right-0 w-2 h-2 -mr-1 -mt-1 bg-pink-400 rounded-full shadow-lg shadow-pink-400/50" style={{ 
                boxShadow: '0 0 10px 2px rgba(244, 114, 182, 0.6)' 
              }}></div>
              {/* Particle 3 - Purple */}
              <div className="absolute bottom-0 left-1/2 w-2 h-2 -ml-1 bg-purple-400 rounded-full shadow-lg shadow-purple-400/50" style={{ 
                boxShadow: '0 0 10px 2px rgba(192, 132, 252, 0.6)' 
              }}></div>
              {/* Particle 4 - Teal */}
              <div className="absolute top-1/2 left-0 w-2 h-2 -ml-1 -mt-1 bg-teal-400 rounded-full shadow-lg shadow-teal-400/50" style={{ 
                boxShadow: '0 0 10px 2px rgba(45, 212, 191, 0.6)' 
              }}></div>
            </div>
            
            {/* Second layer - Smaller particles rotating in opposite direction */}
            <div className="absolute inset-0 w-48 h-48" style={{ animation: 'galaxy-orbit-reverse 120s linear infinite' }}>
              {/* Small Particle 1 */}
              ...
              <div className="absolute" style={{ 
                ...
                boxShadow: '0 0 8px 2px rgba(251, 207, 232, 0.5)'
              }}></div>
              {/* Small Particle 3 */}
              <div className="absolute" style={{ 
                top: '15%', 
                ...
                boxShadow: '0 0 8px 2px rgba(167, 243, 208, 0.5)'
              }}></div>
              {/* Small Particle 4 */}
              <div className="absolute" style={{ 
                top: '85%', 
                ...
                boxShadow: '0 0 8px 2px rgba(196, 181, 253, 0.5)'
              }}></div>
            </div>
            
            {/* Rotating ring effect */}
            <div className="absolute inset-0 w-48 h-48" style={{ animation: 'galaxy-orbit 60s linear infinite' }}>
